...
export function DashboardAlertCard({
  ...
  return (
    ...
    >
      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-sage-soft">
        <Bell size={14} fill="currentColor" strokeWidth={0} className="alert-bell-icon text-sage" />
      </div>
