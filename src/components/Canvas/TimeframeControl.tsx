...
import { TIMEFRAME_OPTIONS, type TimeframePreset } from '../../data/dashboardFilters';
...
export function TimeframeControl({ value, onChange }: TimeframeControlProps) {
  ...
  const label = TIMEFRAME_OPTIONS.find((o) => o.id === value)?.label ?? 'This quarter';
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-full z-20 mt-1.5 min-w-[160px] rounded-xl border border-border bg-surface p-1.5 shadow-soft-lg">
