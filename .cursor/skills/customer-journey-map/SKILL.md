...
You are creating a customer journey map for the product, feature, or persona the user describes in their request.
...
1. **Define the persona**: Who is traveling this journey? Use a specific persona with a job-to-be-done (JTBD), not a generic user.
